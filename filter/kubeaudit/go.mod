module github.com/bluebrown/krm-filter/filter/kubeaudit

go 1.19

// this is here until the PR is merged
// currently pointing to PR fork with cronjob v1 fix
replace github.com/Shopify/kubeaudit => github.com/bluebrown/kubeaudit v0.0.0-20230131005328-effff7809fa1
